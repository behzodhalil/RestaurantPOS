...
@Parcelize
@Entity(tableName = RoomContract.FoodItem.FOOD_ITEM_TABLE)
data class FoodItem(
    @ColumnInfo(name = RoomContract.FoodItem.FOOD_ITEM_NAME)
    val foodItemName : String,
    @ColumnInfo(name = RoomContract.FoodItem.FOOD_ITEM_PRICE)
    val foodItemPrice : Long,
    @ColumnInfo(name = RoomContract.FoodItem.FOOD_ITEM_SUB_COUNT)
    val foodItemSubCount : Int,
    @ColumnInfo(name = RoomContract.FoodItem.FOOD_ITEM_TOTAL_COUNT)
    val foodItemTotalCount : Int,
    @ColumnInfo(name = RoomContract.FoodItem.FOOD_ITEM_CATEGORY)
